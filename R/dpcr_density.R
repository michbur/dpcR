...
#' par(mfrow = c(1, 2))
#' dpcr_density(
#'   k = 25, n = 55, average = TRUE, methods = "wilson",
#'   conf.level = 0.95
#' )
#' dpcr_density(
#'   k = 25, n = 55, average = TRUE, methods = "wilson",
...
#' # calculated
#' dpcr_density(
#'   k = 25, n = 55, average = FALSE, methods = "wilson",
#'   conf.level = 0.95
#' )
#'
#' @export dpcr_density
dpcr_density <- function(k, n, average = FALSE, methods = "wilson",
  ...
  if (plot) {
    ...
    plot_conf_int(conf[1, 4:6], dat, "left",
      conf_int_col = adjustcolor("cyan4",
        alpha.f = 0.15
      ),
      conf_int_border = adjustcolor("cyan4", alpha.f = 0.15)
    )
    plot_conf_int(conf[1, 4:6], dat, "right",
      conf_int_col = adjustcolor("cyan4",
        alpha.f = 0.15
      ),
      conf_int_border = adjustcolor("cyan4", alpha.f = 0.15)
