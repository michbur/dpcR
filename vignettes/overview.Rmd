...
The randomness of spatial distribution on plate can be checked using `test_panel` function.
```{r eval=TRUE}
test_panel(adpcr_experiments, nx_a = 15, ny_a = 16)
```

The lower p-value, the less probable that spatial distribution of the positive partitions is random.
