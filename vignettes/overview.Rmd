...
s4 <- sim_adpcr(m = 100, n = 496, times = 1000, pos_sums = FALSE, n_panels = 3)
# is it a dpcr object?
class(s4)
...
```{r eval=TRUE}
longer_run <- sim_adpcr(m = 10, n = 15, times = 1000, pos_sums = FALSE, n_panels = 1)
shorter_run <- sim_adpcr(m = 10, n = 10, times = 1000, pos_sums = FALSE, n_panels = 1)
shortest_run <- sim_adpcr(m = 10, n = 5, times = 1000, pos_sums = FALSE, n_panels = 1)
...
Digital PCR data is always a matrix (see `?matrix` in R). Columns and rows represent respectively individual runs and their data points. The data points are not always equivalent to partitons, but the true number of partitions for each run is always defined in slot *n*.  
...
# nm
sim_adpcr(m = 235, n = 765, times = 1000, pos_sums = FALSE, n_panels = 3)

# np
binarize(sim_adpcr(m = 235, n = 765, times = 1000, pos_sums = FALSE, n_panels = 3))

# tnp
sim_adpcr(m = 235, n = 765, times = 1000, pos_sums = TRUE, n_panels = 3)
```
